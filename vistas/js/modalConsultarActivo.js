...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // ~~~~~~~~~~~~~~ VARIABLES ~~~~~~~~~~~~~~ //
    var txt_codigo_mCA = document.getElementById('txt_placaBuscarMCA');
    ...
    $('#modalConsultarActivo').on('shown.bs.modal', function () {
        ...
        $('#modalLeerQR').on('hide.bs.modal', function (e) {
            ...
            if (textoQR !== null) {
                txt_codigo_mCA.value = textoQR;
                
                if (esSoloNumeros(textoQR) && textoQR) {
                    /*debugger;*/
                    const btnBuscarActivo = document.getElementById("btnBuscarActivoMCA");
